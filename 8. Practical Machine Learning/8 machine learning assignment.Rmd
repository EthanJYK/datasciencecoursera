...
```{r, getting data, eval=FALSE, echo=FALSE}
# Get files
folder <- getwd()
...
```{r, standardization and PCA, eval=FALSE, echo=FALSE}
# standardization
...
```{r, main functions, eval=FALSE, echo=FALSE}
...
```{r, barplot png creation, eval=FALSE, echo=FALSE}
...
```{r, ensemble, eval=FALSE, echo=FALSE}
# Ensemble
...
```{r, final plot creation, eval=FALSE, echo=FALSE}
# final plot
